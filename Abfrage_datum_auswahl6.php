  ...
  //#######################################################################################################
     ...
     foreach( $Instanzen as $value){
      ...
      //  echo "<th> ".'<img src='."http://127.0.0.1:8042/instances/2b9459cf-60f068a3-f285146f-ca4db519-98757af0/preview".' alt="?" height="75" width="120"/>'."</th>";
        ...
        echo "<th style='border:1; width:150'>Indikation</th>\n";
        echo "<th style='border:1; width:150'>Behandler</th>\n";
        echo "<th style='border:1; width:150'>Ausfuehrender</th>\n";
        echo "<th style='border:1; width:150'>Schwanger</th>\n";
        ...
        echo "</tr>\n";
           ...
           echo "<tr style='align:center'>\n";
            // echo "<td> ".'<img src='."http://127.0.0.1:8042/instances/2b9459cf-60f068a3-f285146f-ca4db519-98757af0/preview".' alt="?" height="100" width="120"/>'."</td>";
             ...
             echo "<td align='center'> <input type ='text' name='Indikation' size='10' border=0>     </td>\n";
             echo "<td align='center'><input type ='text' name='Behandler' size='10'>      </td>\n";
             echo "<td align='center'><input type ='text' name='Ausfuehrender' size='10'>      </td>\n";
             echo "<td align='left'><input type ='text' name='schwanger' size='10'>     </td>\n";
