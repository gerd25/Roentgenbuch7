...
<style>
  ...
  th, td         {padding: 1px;}
  #tabelle       {background-color: 	#8f8f8f;}
...
<div style="position:relative; left:160px; top:1.0cm">
 ...
 <form method="post" action="http://localhost/test/Abfrage_datum_auswahl6.php" >
   ...
   <tr>
    ...
    <th style=' width:180 border : "O" '>PatientID</th>
    <th style=' width:180 border : "O"'>Patient</th>
     ...
     // var_dump($decodedData);
       ...
       //  var_dump($Instanzen);
        ...
        <table  id=tabelle cellspacing=0 border=1px solid align:center' >
          ...
          <th style='border:0; width:180'>AcquisitionNumber</th>
          <th style='border:0; width:180'>InstanceCreationDate</th>
          <th style='border:0; width:150'>InstanceNumber</th>
          ...
          <th style='border:1; width:150'>Indikation</th>
          <th style='border:1; width:150'>Behandler</th>
          <th style='border:1; width:150'>Ausfuehrender</th>
          <th style='border:1; width:150'>Schwanger</th>
          </tr>
          <tr>
          <td></td>
